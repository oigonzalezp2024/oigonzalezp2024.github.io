...
CREATE DATABASE IF NOT EXISTS `control_fabricacion_normal`; 

CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`personas` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`productos_catalogo` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`categorias_insumos` (
  `id_categoria` int(10) UNSIGNED NOT NULL,
  `nombre_categoria` varchar(100) NOT NULL,
  `descripcion` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`materiales` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`ordenes_fabricacion` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`orden_fabricacion_detalles` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`movimientos_inventario` (
...
CREATE TABLE IF NOT EXISTS `control_fabricacion_normal`.`inventario_producto_terminado` (
...
ALTER TABLE `control_fabricacion_normal`.`inventario_producto_terminado`
  ADD PRIMARY KEY (`id_inventario_pt`),
  ADD KEY `fk_ipt_producto` (`producto_id`),
  ADD KEY `fk_ipt_orden` (`orden_id`);

ALTER TABLE `control_fabricacion_normal`.`personas`
  ADD PRIMARY KEY (`id_persona`),
  ADD KEY `idx_persona_rol` (`rol`);

ALTER TABLE `control_fabricacion_normal`.`productos_catalogo`
  ADD PRIMARY KEY (`id_producto`),
  ADD UNIQUE KEY `codigo_referencia` (`codigo_referencia`);

ALTER TABLE `control_fabricacion_normal`.`categorias_insumos`
  ADD PRIMARY KEY (`id_categoria`),
  ADD UNIQUE KEY `nombre_categoria` (`nombre_categoria`);

ALTER TABLE `control_fabricacion_normal`.`materiales`
  ADD PRIMARY KEY (`id_material`),
  ADD UNIQUE KEY `codigo_material` (`codigo_material`),
  ADD KEY `fk_material_categoria` (`categoria_id`);

ALTER TABLE `control_fabricacion_normal`.`ordenes_fabricacion`
...
ALTER TABLE `control_fabricacion_normal`.`orden_fabricacion_detalles`
  ADD PRIMARY KEY (`id_detalle`),
  ADD KEY `fk_detalle_orden` (`orden_id`),
  ADD KEY `fk_detalle_material` (`material_id`);

ALTER TABLE `control_fabricacion_normal`.`movimientos_inventario`
...
ALTER TABLE `control_fabricacion_normal`.`materiales`
  ...
  REFERENCES `categorias_insumos` (`id_categoria`) 
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`categorias_insumos` (`id_categoria`, `nombre_categoria`, `descripcion`) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`productos_catalogo` (`id_producto`, `codigo_referencia`, `nombre_producto`, `descripcion`) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`personas` (`id_persona`, `documento`, `nombre`, `rol`, `telefono`) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`materiales` (`id_material`, `codigo_material`, `descripcion_material`, `unidad_medida`, `precio_unitario_defecto`, `categoria_id`, `stock_minimo`, `stock_actual`, `stock_maximo`) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`ordenes_fabricacion` 
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`orden_fabricacion_detalles` (`orden_id`, `material_id`, `medidas`, `cantidad`, `cantidad_consumida`, `valor_unitario`) VALUES
-- Escritorio Mueble
...
INSERT INTO `control_fabricacion_normal`.`movimientos_inventario` (`tipo_item`, `id_item`, `tipo_movimiento`, `cantidad`, `orden_id`, `observacion`) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO `control_fabricacion_normal`.`inventario_producto_terminado` 
